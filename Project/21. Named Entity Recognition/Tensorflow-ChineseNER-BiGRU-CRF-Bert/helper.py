...
parser.add_argument("-bc", "--bert_config", type=str, help="bert config file dir", default="bert_model/chinese_L-12_H-768_A-12/bert_config.json")
parser.add_argument("-od", "--output_dir", type=str, help="output dir", default="output")
parser.add_argument("-ic", "--init_checkpoint", type=str, help="bert model dir", default="bert_model/chinese_L-12_H-768_A-12/bert_model.ckpt")
parser.add_argument("-v", "--vocab_dir", type=str, help="vocab dir", default="bert_model/chinese_L-12_H-768_A-12/vocab.txt")
